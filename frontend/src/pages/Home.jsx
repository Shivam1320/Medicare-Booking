      ...
      <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
        ...
        <div>
          <div className="lg:w-[570px]">
            ...
            <p className="text__para">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Commodi,
             iure possimus odio eveniet sequi animi debitis quibusdam enim nemo dolorem nostrum officia 
             perspiciatis sint eius tenetur, amet accusantium error odit? 
            </p>
      ...
      <div className='xl:w-[670px]'>
        ...
        <ul className='pl-4'>
          ...
          <li className='text__para'>
            ...
            online <br /> scheduling tool to select an appointment time.
          </li>
        </ul>
      ...
      <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
        ...
        [100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
          ...
          <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'>
            ...
            <h4 className='text-[10px] leading-3 g:text-[16px] lg:leading-[22px] font-[700]
            text-headingColor'> 
              Wayne Collins
            </h4>
          </div>
