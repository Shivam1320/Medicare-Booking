           ...
           {/* ---------- Doctor's info start ----------- */}
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Shivam Kumar</h3>
                ...
                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
                Rem consectetur earum nemo nulla deleniti ut ratione quod! Magni, eius atque.
                </p>
              </div>
            </div>
           {/* ---------- Doctor's info end ----------- */}
